...
class PhysicsLessonResourceProvider(private val context: Context) : RecentTopicResourceProvider {

    override fun getPlayButtonDrawable(): Drawable? =
        context.getImage(R.drawable.play_button_physics)

    override fun getColor(): Int = context.getColorResId(R.color.subject_physics)

...
class MathematicsResourceProvider(private val context: Context) : SubjectResourceProvider {

    override fun getBackgroundDrawable(): Drawable? =
        context.getImage(R.drawable.subject_background_mathematics)

    override fun getColor(): Int = context.getColorResId(R.color.subject_mathematics)

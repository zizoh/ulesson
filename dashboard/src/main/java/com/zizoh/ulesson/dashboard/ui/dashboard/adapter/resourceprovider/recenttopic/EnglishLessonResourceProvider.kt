...
class EnglishLessonResourceProvider(private val context: Context) : RecentTopicResourceProvider {

    override fun getPlayButtonDrawable(): Drawable? =
        context.getImage(R.drawable.play_button_english)

    override fun getColor(): Int = context.getColorResId(R.color.subject_english)
